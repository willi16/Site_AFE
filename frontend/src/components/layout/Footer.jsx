        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-surface-400 text-sm leading-relaxed mb-6">
              L'Association Fraternité et Entraide œuvre pour le bien-être et l'entraide au sein de notre communauté depuis sa création.
            </p>
      ...
      <div className="border-t border-surface-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-surface-500">
            &copy; {new Date().getFullYear()} AFE - Association Fraternité et Entraide. Tous droits réservés.
          </p>
